                                        ...
                                        <div class="card-body">
                                                ...
                                                <div class="form-group col-md-6 ">
                                                    <div class="form-group">
                                                        ...
                                                        <div class="input-group date" id="ido"
                                                            ...
                                                            <div class="form-control"><%=order.getOder_id()%>
                                                            </div>
                                                            <input type="hidden" name="order_id"
                                                                   value="<%=order.getOder_id()%>">
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="form-group col-md-6 ">
                                                    <label>Tên khách hàng</label>
                                                    <div class="form-control"><%=order.getFullName(order.getUser_name())%>
                                                    </div>
                                                </div>
                                            </div>
                                            <div style="display: flex" class="row">
                                                <div class="form-group col-md-6 ">
                                                    <div class="form-group">
                                                        ...
                                                        <div class="input-group date" id="reservationdate1"
                                                             data-target-input="nearest">
                                                            <div class="form-control"><%=order.getPhoneNum()%>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="form-group col-md-6 ">
                                                    <div class="form-group">
                                                        ...
                                                        <div class="input-group date" id="reservationdate2"
                                                             data-target-input="nearest">
                                                            <div class="form-control"><%=Order.convertDateTime(order.getDate_order().toString())%>
                                                            </div>
                                            ...
                                            <div style="display: flex" class="row">
                                                <div class="form-group col-md-12 ">
                                                    ...
                                                    <div class="form-control"><%=order.getAddress()%>
                                                    </div>
                                                    <input type="hidden" name="address" id="address"
                                                           class="form-control" value="<%= order.getAddress() %>">
                                                </div>
                                                <div class="form-group col-md-12 ">
                                                    <label>Mã địa chỉ giao hàng</label>
                                                    <div class="form-control"><%=order.getTransport()%>
                                                    </div>
                                                    <input type="hidden" name="addressId" id="addressId"
                                                           class="form-control" value="<%= order.getTransport() %>">
                                                </div>
                                            </div>
                                            <div style="display: flex" class="row">
                                                <div class="form-group col-md-12 ">
                                                    <label>Ghi chú của khách hàng</label>
                                                    <div class="form-control"><%=order.getNote()%>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group col-md-6 ">
                                            <div class="form-group">
                                                ...
                                                <div class="input-group date" id="reservationdate6"
                                                     data-target-input="nearest">
                                                    <div class="form-control"><%=order.getPayment()%>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
...
<script>
    $(document).ready(function () {
        ...
        var orderCheck =
        <%=CheckOrders.checkOrderIsNotChange(order.getOder_id())%>
        var orderPays = "<%=order.getPayment()%>";
        console.log(orderPays);
        console.log(orderCheck);
        $('select[name="status"] option[value="' + orderStatus + '"]').prop('selected', true);

        if (!orderCheck && orderPays == "Giao hàng thu tiền tận nhà" || orderPays == "Nhận hàng tại cửa hàng") {
