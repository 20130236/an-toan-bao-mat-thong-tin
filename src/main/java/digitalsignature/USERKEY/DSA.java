...
//    private PublicKey getPublicKeyFromDatabase(String username) {
//        Connection connection = null;
//        PreparedStatement preparedStatement = null;
...
//            String sql = "SELECT publickey FROM userkeys WHERE username = ? AND status = 1";
//            preparedStatement = connection.prepareStatement(sql);
...
//    }
//    //lấy tên file private key từ request
